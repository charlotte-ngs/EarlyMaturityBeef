...
* __Heritability__ ($h^2$) Selection success divided by selection differential (Selektionsintensität). The higher, the more the trait is dependent on the genetics of the population [@VonRohr2017].

* __Selection differential__ The measure of the selection applied, which is the average superiority of the selected parents compared to the population mean [@Falconer1996].
