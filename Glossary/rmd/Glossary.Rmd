...
bibliography: ["Erikson2003.bib", "Williams2010.bib", "Kunz2018.bib","ABZ2017.bib", "Mutterkuh2018.bib", "KunzStrasser2018.bib", "vonRohr2017.bib"]
---
...
* __Standard deviation__ Is the mean absolute deviation to the mean of all observations or the Erwartungswert (when stetig). When we calculate a model, we have a line that is stetig, so there we can not just use the mean, but have to define what we mean. Usually we just mean the difference to the line.
