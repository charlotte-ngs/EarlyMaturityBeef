...
* __Response to selection__ (R) $R=ih^2\sigma_{P}$. Is the difference of the population mean over a period of time. You can predict it using the information of the deterministic breeding plan: Intensity of selection, the variance of the aggregate genotypes and breeding accuracy.
...
* __Residual feed intake__ Found in the paper of Berry.
...
* __Asymptotic genetic additive variance-covariance matrix__ (G^*) An n x n matrix (n=number of traits) that is dependent on G, asymptotic C and a.
