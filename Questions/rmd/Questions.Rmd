...
* How can you include R result in the text of R markdown?
...
* How do I write and interpret the summation symbol big sigma?
    * You write it like this: $\sum_{i=1}^{n}$
...
rownames(tbl_prop_sel) <- c("Proportion selected $P$ [%]")
knitr::kable(tbl_prop_sel)
```
* How should I call Gesamtzuchtwert? Overall breeding value probably.
    * 
    
* Is the covariance (Zusammenhang) between these breeding values connected by the heritability of each trait?
    *
