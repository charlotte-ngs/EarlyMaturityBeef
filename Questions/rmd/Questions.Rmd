...
* Is the generation intervall and intensity of selection for calves and stitchs different?
...
\autoref{tab:calf gentic variance-covariance matrix}
```{r variancecomponents, echo=FALSE}
library(huxtable)
tbl_variancecomponents <- tibble::data_frame(c("calf cc","stirk cc", "calf cf", "stirk cf", "calf cw", "stirk cw"), c(0.5, 0.83, -0.05, -0.17, 0.52, 0.29), c(0.83, 0.56, -0.03,0.15, 0.36,0.38 ), c(-0.05, -0.03, 0.31,0.73,-0.03,0.09), c(-0.17, 0.15, 0.73, 0.36,-0.20,0.26), c( 0.52, 0.36, -0.03, -0.20, 0.22,0.63 ), c(0.29,0.38,0.09,0.26,0.63,0.3), c(0.63, 0.63, 0.35, 0.36, 0.06, 0.14))
colnames(tbl_variancecomponents) <- c(NA,"calf cc","stirk cc", "calf cf", "stirk cf", "calf cw", "stirk cw", "gen sd")
...
# setting the caption
caption(ht_prop_sel) <- 'genetic correlations and heritabilities'
