...
Lately it has been observed that carcass fat is decreasing at least for some beef cattle breeds. The decrease of carcass fat leads to a price reduction of the carcass [@Hospenthal2016]. (Hier noch Graph zeigen mit Entwicklung carcass fat over years in switzerland, Sophie fragen)
...
The more incissors the physiologically older the animal. Table \@autoref(tab:slaughtercategory) contains the list of carcass categories and their description used in CHTAX.
...
A detailed description of the distinct carcass conformation classes is available at \@ autoref(tab:conformationclass).
...
As an example \@autoref(tab:conformationclass) the basis prices per kilogram carcass and live weight for a carcass of the slaughter category young bulls (MT) are available.
...
<!--chapter:end:05-conculsions.Rmd-->
