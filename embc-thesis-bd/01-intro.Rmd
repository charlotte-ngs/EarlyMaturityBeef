...
Until now, most selection in beef cattle could not change the growth curve and its relationship with the body composition [@Thonney2015].
...
Therefore two less complex strategies were proposed to breed for early maturity in Switzerland and are evaluated in this Master thesis:
...
Two tools were used to predict the effects of the two strategies: The genetic gain (see Section  \@ref(gengain)) and the rank correlations (see Section \@ref(rankcorr)).
