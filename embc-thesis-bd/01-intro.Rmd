...
Up until summer 2018, the Swiss beef cattle breeders association "Mutterkuh Schweiz" has been focusing their genetic evaluations mainly on growth rate and carcass conformation. 
...
The animal, which is younger, will then be earlier mature than the other one.
Early maturity is important for Swiss beef keeping farmers, because it reduces their fattening costs [@Berry2017].
...
However, until now most selection in beef cattle could not change the growth curve and its relationship with body composition [@Thonney2015].
...
The underlying trait carcass fat is based on records classifying different levels of fat coverage on beef carcasses (see Figure \@ref(fig:cfgraphic)).
