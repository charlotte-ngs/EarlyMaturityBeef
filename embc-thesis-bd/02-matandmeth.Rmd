...
\end{equation}
$$I=a'u$$
where $a$ was the vector of economic weights and $u$ was the vector of estimated breeding values.
Both vectors had one entry for each trait which took the same places in $a$ and $u$.
...
However, in this project there was no information available about the true change in profit per trait unit.
