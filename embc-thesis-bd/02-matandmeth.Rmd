...
It is important to improve __early maturity__ in Swiss beef cattle as explained in section \@ref(intro). 
...
The following definition of "early maturity" is valid in the context of this project : Animals are earlier mature if they reach the state of carcass maturity faster than others. 
Animals reach carcass maturity when their carcass does not get any price reductions per kg carcass weight (CW) when sold at the slaughterhouse. 
...
Carcass categories differ in the animals age at slaughter, anatomical maturity, sex and carcass weight (see table  \@ref(tab:slaughtercategory).
Whereas the farmer provides information about age at slaughter and sex, Proviande employees determine anatomical maturity and carcass weight.
...
kable(x, booktabs=T, caption="Description of slaughter categories (Proviande, 2015)") %>%
kable_styling(full_width =T) %>%
column_spec(3, width="8cm")
```

The second step in the classification system CHTAX is assigning the carcass to a carcass conformation class (CC) within its slaughter category.
In this step Proviande employees visually classify the carcass into seven classes of carcass conformation (see table  \@ref(tab:conformationclass)).
...
In combination with the slaughter category the carcass conformation class determines the basis price of an animal per kilogram carcass weight.

The third step in CHTAX is assigning the carcass to one of five carcass fat classes.
...
**Here the text interrupts its flow. I need to go on with, what this thesis has to do with the description of the breeding value estimation. Somehow like: My task is to find out how high the genetic gain in carcass fat can be over several years.**
...
Proviande employees record the traits at slaughterhouses in Switzerland routeneley according to CHTAX (see section \ref(CHTAX)).
