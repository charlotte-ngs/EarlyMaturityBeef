...
This thesis builds on the following definition: Animals mature early if they reach the state of carcass maturity faster than others. 
Animals reach carcass maturity when their carcass does not get any price reductions per kg carcass weight when sold at the slaughterhouse. 
...
The estimated variance components have been used to predict the genetic gain (Q) for two breeding scenarios where both "calves" and "stirks" breeding values have been included.
The first scenarium assuming a selection for only carcass fat and the second scenarium assuming a selection for an economically weighed combination of carcass fat, carcass conformation and carcass weight.
...
From the assumption that BLUP-based estimated breeding values will be used in both scenarios
