...
It is important to improve __early maturity__ in Swiss beef cattle, based on the earlier made observation in chapter \@ref(intro). 
One possibility is to use early maturity in a breeding program. 
...
Since 1994 the payment system of Swiss slaughterhouses is based on the carcass classification system CHTAX (see \@ref(CHTAX)) [Kaufmann1995].
