...
The Swiss breeding value for carcass fat was introduced in summer 2018.
Therefore all necessary data for the predictions was available to evaluate the strategy *Carcass fat as auxilliary trait*.
...
All predictions assumed within-breed breeding and were performed for the breeds Angus (Referenz für Bild Angus und Beschreibung: Angus is a extensive beef breed originating from the UK??) and Limousin (Referenz für Bild: Limousin is an intensive beef breed originating from France??).
Additionally both beef breed populations were divided into the groups *calves* and *adults*.
