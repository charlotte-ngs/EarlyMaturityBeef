...
This means that carcass fat is highly correlated with early maturity.
...
Multivariate BLUP is a statistical model combining the given knowledge about animal relationships, trait heritabilities, phenotypical variances of traits in a population, environment factors, individual phenotypic observations and trait correlations to a breeding value.
The phenotypic observations used are:

* carcass fat class as described in \@ref(tab:fatclass) corrected by age at slaughter [d]
* conformation class as described in \@ref(tab:conformationclass) corrected by age at slaughter [d]
* carcass weight [dt] corrected by age at slaughter [d]
...
These environmental effects have been included in BLUP and used to separate additive genetic effects from environmental effects. 
