...
Adult beef animals are slaughtered in considerably higher numbers than calves in Switzerland.
For example in 2016 ???? [Agristat2018].
Therefore, the used model to compute the economic weights could be improved by considering the frequencies of *calves* and *adults* slaughtered in Switzerland.
...
Again this followes from the payment system CHTAX, where carcass conformation was a maximum trait and carcass fat is an optimum trait.
...
In other studies carcass weight was usually the most important trait in the computed index [@Aby2012;?? ].
The most important reason for this difference may be that in this Master thesis the unit [(Sfr. / kg carcass weight) / trait unit] was used for the economic weights.
