...
The economic weights are shown corrected for each trait's genetic standard deviation in the Swiss beef population (see Figure \@ref(fig:ecweightsgensdfig)).
...
This was due to generally high genetic correlations between carcass weight and the other traits.
Therefor it did not represented the negative economic weights for carcass weight (see Table \@ref(tab:ecweightstab)).
