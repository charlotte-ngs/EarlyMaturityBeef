...
# Compute economic value
compute_economic_value(pvec_class_freq = t(pvec_class_freq), pn_sd = pn_sd, pn_mean = pn_mean, pvec_price = t(pvec_price), pn_delta_mean = pn_delta_mean)

compute_economic_value(pvec_threshold = pvec_threshold, pn_sd = 45, pn_mean = 242, pvec_price = pvec_price, pn_delta_mean = 0.01)
```
