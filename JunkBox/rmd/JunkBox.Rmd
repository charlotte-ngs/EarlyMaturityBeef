...
data_frame(
Abbreviation = c("Calves", "s", "CW") , Term = c("calves: less or 180 d old animals", "stirks: more than 180 d but less than 700 d old animals", "carcass weight")
  ) %>%
...
There has been proposed an attempt to perform this change based on a model combining the records of age at slaughter and other carcass traits.
...
The DAGE is able to select for beef animals which are earlier mature than expected.
The expections may be based on environmental factors and the sex of the beef animal.
...
However the complexity of the DAGE could complicate the computation of its genetic gain which would be used to compare the DAGE with other breeding strategies.
