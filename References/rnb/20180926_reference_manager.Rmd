...
The analysis of the literature citations requires to read the content of the currently used Rmd-document. One way to determine this is via 
...
See https://stackoverflow.com/questions/47044068/get-the-path-of-current-script/47045368 for more details. But this works only for a notebook when running in preview-mode. It does not work when knitting the document. 


## Figure and Tables
References to figures and tables must not be listed as literature content.

```{r cars-mpg-cyl, fig.cap="Cars Data MPG vs CYL"}
