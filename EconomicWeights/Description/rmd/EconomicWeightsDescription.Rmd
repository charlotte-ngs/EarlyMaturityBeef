...
Economic weights are weighing factors to produce an index $I$
...
Therefore the change in profit is approximated by the difference in price per kg carcass weight determined by CHTAX.
