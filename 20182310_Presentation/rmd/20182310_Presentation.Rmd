...
* Index as selection criterion --> weighted mean
...
$a$ is the vector of economic weights,
...
* Simplification: (Sfr/kg carcass weight) / breeding value unit
...
* Carcass fat -> How fatty?

* Carcass conformation -> How meaty?

* Carcass weight -> How heavy?

* Calves are < 180 d old

* Adults are > 180 < 701 d old
...
table$Trait <- c("Calves Conformation [Sfr./Class]", "Adults Conformation [Sfr./Class]", "Calves Fat [Sfr./Class]", "Adults Fat [Sfr./Class]", "Calves Weight [Sfr./kg]", "Adults Weight [Sfr./kg]")
