...
Sfr <- c(QaCF,QcCF,QaCC,QcCC,QaCW,QcCW)*a

data.frame(trait=c("CFa","CFc","CCa","CCc","CWa","CWc"), Sfr=Sfr)
sum(Sfr)
```
...
data.frame(trait=c("CFa","CFc","CCa","CCc","CWa","CWc"), Sfr=c(CFaQ,CFcQ,CCaQ,CCcQ,CWaQ,CWcQ))
