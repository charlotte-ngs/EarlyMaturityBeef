...
### Accuracy of the estimated overall breeding value of the selection candidate $r^*$

$$r^*=\sqrt{\frac {a^TC^*a}{a^TG^*a}}$$

```{r AccuracyOverall}
ra <- sqrt((t(a)*Ca*a)/(t(a)*Ga*a))
```

### Standard deviation of the estimated overall breeding value of the selection candidate $\sigma^*$
