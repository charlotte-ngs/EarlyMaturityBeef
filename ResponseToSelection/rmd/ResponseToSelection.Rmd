...
\left( 
\begin{matrix}
1/\sigma_e^2X'X  &  1/\sigma_e^2X'Z \\
1/\sigma_e^2Z'X   &  1/\sigma_e^2Z'Z+1/\sigma_e^2A^{-1}
\end{matrix}
\right)^{-1}
$$
...
$X$ is a vector of the values 1,1,1, etc.
...
For $Z$ we have the following matrix:

```{r}
Z <- matrix(0,nrow=23, ncol=21)
diag(Z)<-1
Z
```
...
suppressPackageStartupMessages( library(pedigreemm))
nNrAni <- 23
ped <- pedigree(sire = c(NA,NA,1,1,1,1,1,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA), dam = c(NA,NA,2,2,2,2,2,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA), label = 1:nNrAni)
print(ped)
```
