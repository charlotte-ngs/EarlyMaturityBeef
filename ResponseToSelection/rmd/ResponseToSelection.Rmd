...
The response to selection of the total breeding value $Q$ is dependent on the parameters:
...
$M$ is the genetic variance-covariance matrix which consists of $G$ and $A_y$.

The diagonal elements of V are the phenotypic variances $\sigma_p$ of each trait.
...
sigp<-sigg/h2
```
I also have the the non-diagonal elements, which are the phenotypical covariances.
Therefore I can compute $V$ similarly to $G$.
