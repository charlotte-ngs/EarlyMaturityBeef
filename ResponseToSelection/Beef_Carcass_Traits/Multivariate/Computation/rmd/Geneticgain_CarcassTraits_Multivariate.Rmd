...
# library(ggplot2)
#   
dataframe <- data.frame(names = c("Overall",rep(c("CFa","CFc","CCa","CCc","CWa","CWc"),times=2)), Sfr = c(Qoverall_index,CFaQ,CFcQ,CCaQ,CCcQ,CWaQ,CWcQ,QaCF,QcCF,QaCC,QcCC,QaCW,QcCW), Strategy=c("index",rep(c("CFa","index"),each=6)))
# 
