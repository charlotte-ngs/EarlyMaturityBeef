...
a <- "selection_on_CF_economic_values"
...
#AN_index <- data.frame(trait=c("CFa","CFc","CCa","CCc","CWa","CWc"), Sfr=c(QaCF,QcCF,QaCC,QcCC,QaCW,QcCW))

AN_CFA <- data.frame(trait=c("CFa","CFc","CCa","CCc","CWa","CWc"), Sfr=c(QaCF,QcCF,QaCC,QcCC,QaCW,QcCW))

AN <- ggplot(AN_index,aes(trait,Sfr))
AN + geom_bar(stat="identity")
sum(c(QaCF,QcCF,QaCC,QcCC,QaCW,QcCW))

AN <- ggplot(AN_CFA,aes(trait,Sfr))
AN + geom_bar(stat="identity")
sum(c(QaCF,QcCF,QaCC,QcCC,QaCW,QcCW))
diag(Ga)
diag(G)
