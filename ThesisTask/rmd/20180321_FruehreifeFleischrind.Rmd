...
mainly on growth rate and carcass conformation. 
There might be evidence that
the level of carcass fatness is decreasing at least for some beef cattle breeds [@Hospenthal2016]. 
Several stakeholders derive from the decreasing levels of carcass fat a decreasing rate of maturation of Swiss beef cattle (Dieser Satz sollte auf grammatikalische Korrektheit überprüft werden).
...
Cattle beef producers get important selling price reductions per carcass weight when carcass fat (Bild von Rückenspeckdicke dick und dünn), carcass conformation (Bild gute Fleischigkeit, schlechte Fleischigkeit) and carcass weight are not fitting to the desired frame. 
For example a young bull (MT) of 200 kg carcass weight will cost 1910 when in the favouverd categories of carcass conformation and carcass fat and 1400 in the least favoured categories, which is 27% less [@Proviande2018]. 
...
However, in Switzerland the carcass should not weight too much. More than 290 kg carcass weight will result in a price discount of at least 0.1.-/kg carcass weight [@Proviande2018]. 

Actually generally beef carcasses in Switzerland are much smaller than abroad in order to fulfill the wishes of the market. 
That is why beef cattle in Switzerland has to be earlier mature than abroad [@Hospenthal2016]. 


## Rate of maturation derived from carcass fat
...
As mentioned in the first paragraph several stakeholders believe that carcass fat and early maturity are closely correlated. 
This is due to the fact that "growth and body composition are inextricably linked" [@Thonney2015]. 
...
This shows that carcass fat is generally the limiting factor to fulfill the requirements to be slaughtered. 
...
The adult weight is defined as the asymptotic weight of this growth curve. 
As the adult weight increases the growth rate generally increases aswell at a given weight. 
As   When the adult size is high, the (Figure 21.4)
...
To use this link between early maturity and carcass fat, beef cattle breeders in Switzerland have decided to estimate breeding values for carcass fat. 
The heritability (0.31) would be high enough for carcass fat to efficiently breed for it [@Hospenthal2016]. 

However you need some evidence that carcass fat and early maturity are closely linked to each other. 
Otherwise you might eventually select animals that are early in running to fat but are still light and thin. 
Then the deriving trait carcass fat would not be sufficient to derive the trait early maturity.
...
Also they use an multi-trait across breed animal model. There the include 15 traits including carcass weight and carcass fat. 
