...
The rate of maturation ("Frühreife") is here defined as the amount of time until an animal reaches the necessary requirements to be slaughtered without any price reductions per kg of carcass weight. Commercial cattle are generally determined as ready for slaughter by visual inspection of the degree of fatness within the appropriate range of live weight [@VanGroningen2006].
...
Here more information about classifying carcasses by age and gender. And more about Mutterkuh Schweiz and the situation that most beef cattle are crosses between beef sires and dairy dams? All the information in Hospenthal available.

Generally beef carcasses in Switzerland are much smaller than abroad in order to fulfill the wishes of the market. 
Therefore beef cattle in Switzerland has to mature earlier than abroad [@Hospenthal2016]. 
This project aims at comparing different breeding strategies to increase the rate of maturation of beef cattle in Switzerland to address this need.
...
Cattle with higher adult weight tend to increase carcass fat at lower body weight (Figure 21.4) [@Thonney2015].
