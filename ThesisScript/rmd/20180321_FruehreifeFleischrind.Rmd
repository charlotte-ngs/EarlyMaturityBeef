...
Early maturity ("Frühreife") is defined as the amount of time until an animal reaches the necessary requirements to be slaughtered without any price reductions per kg of carcass weight. 
The definitions including the verb mature can be confusing. 
