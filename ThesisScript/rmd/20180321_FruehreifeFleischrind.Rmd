...
Lately it has been observed that carcass fat is decreasing at least for some beef cattle breeds [@Hospenthal2016]. 
...
Cattle beef producers get important selling price reductions per carcass weight when carcass fat, carcass conformation and carcass weight are not fitting to the desired frame. 

For example the price of a young bull (MT) of 200 kg carcass weight is 1910.- when in the most favoured classes of carcass conformation and carcass fat and 1400.- when in the least favoured classes [@Proviande2018]. 
...
* __Intramuscular fat content []
* __Tenderness
* __Trimming effort

Negativeley correlated with carcass fat:
* __Cold shortening
* __Storage weight loss
...
Their classification is based on the classification system CH-TAX [@Proviande2015]:
...
3. The price of the carcass is estimated. For carcass conformation the price is maximal at the end of the scale and for carcass fat at the center of the scale (3).
