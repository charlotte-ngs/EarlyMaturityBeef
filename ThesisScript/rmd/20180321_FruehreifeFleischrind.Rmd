...
Lately it has been observed that carcass fatness is decreasing at least for some beef cattle breeds [@Hospenthal2016]. 
Several stakeholders derive from the decreasing levels of carcass fat that Swiss cattle is worsening in the trait early maturity (Dieser Satz sollte auf grammatikalische Korrektheit überprüft werden).
...
The beef meat market in Switzerland is controlled by the sector association "Proviande". Proviande employees classify carcass quality in large-scale slaughterhouses to determine the price. 
Their classification is based on the classification system CH-TAX. 

First the category of the carcass is defined by physiological age at slaughter, sex and carcass weight (Tabelle von Hospenthal übernehmen). 
Then the carcass is visually classified for carcass conformation and carcass fat. 
Carcass conformation describes how meaty the carcass is and carcass fat describes how fat the carcass is.
For carcass conformation the price is maximal at the end of the scale and for carcass fat at the center of the scale (3) [@Proviande2018].
...
In summer 2018 the new breeding value carcass fat for beef cattle in Switzerland has been launched.
This project aims at comparing different breeding strategies to improve the early maturity in land to address this need.
