...
x1<-data.frame(class=c(1,2,3,4,5),
               Angus1=c(0.030, 0.125, 0.580, 0.240, 0.025), 
               Limousin1=c(0.05, 0.26, 0.60, 0.09, 0.00))
#old means
...
x2<-data.frame(class=c(1,2,3,4,5),
               ...
               Angus2=c(0.030, 0.125+0.5*d, 0.580+1.5*d, 0.240-2*d, 0.025),
               Limousin2=c(0.05-d, 0.26-d, 0.60+2*d, 0.09, 0.00))
#new means
